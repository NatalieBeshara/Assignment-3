...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        HSTLabel.topAnchor.constraint(equalTo: subtotalLabel.bottomAnchor, constant: 20).isActive = true
        ...
        finalTotalPriceLabel.topAnchor.constraint(equalTo: HSTLabel.bottomAnchor, constant: 20).isActive = true
    }
    @objc func calculatePrice() {
        ...
        if toppings == 1 {
            ...
            priceOfToppings = 1.75
        }
        else if toppings == 3 {
            priceOfToppings = 2.50
        }
        else if toppings == 4{
            priceOfToppings = 3.25
        }
        else{
        ...
        subtotalLabel.text = String(format: "Subtotal: $%.02f", price)
        HSTLabel.text = String(format: "HST: $%.02f", HST)
        finalTotalPriceLabel.text = String(format: "Final Total: $%.02f", totalPrice)
